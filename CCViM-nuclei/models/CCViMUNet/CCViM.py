...
@register_model
def CCViM(*args,in_chans=3,dims=[96, 192, 384, 768],
                     depths=[2, 2, 2, 2],depths_decoder=[2,2,2,1],dims_decoder=[768, 384, 192, 96],
                     d_state=16, drop_path_rate=0.2,freeze=False,nr_types=None, **kwargs):
    ...
    return VSSM(in_chans=in_chans,dims=dims, depths=depths,dims_decoder=dims_decoder,
                depths_decoder=depths_decoder, d_state=d_state,drop_path_rate=drop_path_rate,
                directions=directions,decoder_directions=decoder_directions,freeze=freeze,nr_types=nr_types)
